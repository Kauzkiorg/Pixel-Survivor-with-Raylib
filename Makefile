...
# Define all object files from source files - collect ALL cpp files recursively from src/
ALL_SRC = $(call rwildcard, src/, *.cpp)
...
$(PROJECT_NAME):
	$(CC) -o $(PROJECT_NAME)$(EXT) $(ALL_SRC) $(CFLAGS) $(INCLUDE_PATHS) $(LDFLAGS) $(LDLIBS) -D$(PLATFORM)
